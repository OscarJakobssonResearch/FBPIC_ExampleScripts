...
- Lasers are initialized using an antenna. This is located at the right-hand side of the simulation window 
at z0antenna=0. 
...
# The simulation box
Nz = 2100			# Number of gridpoints along z
...
dt_period = 30e-15		  # Period of the diagnostics in number of timesteps
...
L_interact = 20*lambdap # increase to simulate longer distance!
...
if __name__ == '__main__':
	...
	sim.diags = [ FieldDiagnostic(dt_period/sim.dt, sim.fld, comm=sim.comm),
				  ...
				  ParticleDiagnostic( dt_period/sim.dt, {"beam" : beam}, particle_data=["position", "momentum", "weighting", "E", "B", "gamma"],comm=sim.comm)]
	# Add checkpoints
	if save_checkpoints:
